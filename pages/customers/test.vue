    ...
    <div class="content-right">
      ...
      <b-card  class="overflow-scroll">
        <b-row align-h="between">
          ...
          <b-col cols="4">
             <a href="#" @click="$store.commit('switchForm',{ title:'Add Customer'})" class="float-right" ><b-icon icon="plus-circle-fill" scale="2" class="mx-3" variant="primary" ></b-icon></a>
          </b-col>
        </b-row>
        <b-row align-h="between">
          ...
          <b-col sm="5" md="5" class="my-1 mb-2">
            ...
            <b-input-group-append>
              <b-button :disabled="!searchCriteria" @click="clearSearch">Clear</b-button>
            </b-input-group-append>
          </b-input-group>
          </b-col>
        ...
        <br>
        <b-list-group>
          <b-list-group-item href="#" v-for="item in items" :key="item.id">
            <b-row>
              <b-col md="4">
                <div class="d-flex align-items-center">
                  <img :src="`${item.imageFolder}`" width="70px" class="mr-3"/>
              ...
              <b-col md="4">
                <p class="text-center">
              21 Main Street,<br> Wallingford, PA 19086
            </p>
              </b-col>
              <b-col md="4">
        ...
        <b-col sm="7" md="6" class="mx-auto mt-3">
